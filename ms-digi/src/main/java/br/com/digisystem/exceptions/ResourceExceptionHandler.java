...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<ValidationError> methodValidation(MethodArgumentNotValidException e, HttpServletRequest request) {
		...
		error.setMessage("Erro na validação dos dados na operação");
